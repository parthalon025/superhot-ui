...
export const corpus = {
  ...
  cave: {
    toast: [
      ...
      "All right, I've been thinking. And I think that notification was important. Probably.",
      "Those of you helping us test this — you're doing something important. History will remember you. Probably.",
    ],
    error: [
    ...
    loading: [
      ...
      "Loading isn't about patience. It's about results. And we're getting there. Probably.",
  ...
  turret: {
    ...
    success: ["There you are.", "Well done.", "Your business is appreciated."],
